...
namespace RCS.DTV.RZC.ViewModels
{
    ...
    /// </para>
    /// </summary>
    public class AfcDivisionViewModel : ViewModelBase<AfcDivisionViewModel>
    {
        // TODO: Add a member for IXxxServiceAgent
        private IPlayoffDivisionServiceAgent _serviceAgent;

        // Default ctor
        public AfcDivisionViewModel() { }

        // TODO: ctor that accepts IXxxServiceAgent
        public AfcDivisionViewModel(IPlayoffDivisionServiceAgent serviceAgent)
        {
        ...
        {
            SaveToXML();
            _serviceAgent.SetPlayoffDivisionData("AFC", PlayoffTeams);
        }
        ...
        private void SaveToXML()
        {
            ...
            try
            {
                ...
                var afc = doc.Root.Descendants("AFC");
