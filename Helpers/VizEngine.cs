...
namespace RCS.DTV.RZC.Helpers
{
    public class VizEngine : INotifyPropertyChanged
    {
        ...
        public int Port { get { return _engine.Port; } 
            set
            {
                if ( Connected )
        ...
        public string IP { get { return _engine.HostnameOrIP; } 
            set 
        ...
        public void Invoke( string script )
        {
            ...
            //else
                //NotificationManager.Push("Viz Connection", "Viz is currently not connected");
        }
